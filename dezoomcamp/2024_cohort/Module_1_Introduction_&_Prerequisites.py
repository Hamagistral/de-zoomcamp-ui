...
st.markdown("### 2. Introduction Terraform: Concepts and Overview")

st.video("https://www.youtube.com/watch?v=s2bOYDCKl_M")

st.markdown("---")

st.markdown("### 3. Terraform Basics: Simple one file Terraform Deployment")

st.video("https://www.youtube.com/watch?v=Y2ux7gq3Z0o")


st.markdown("---")

st.markdown("### 4. Deployment with a Variables File")

st.video("https://www.youtube.com/watch?v=PBi0hHjLftk")

st.markdown("""
* [Companion Notes](https://github.com/DataTalksClub/data-engineering-zoomcamp/tree/main/week_1_basics_n_setup/1_terraform_gcp)
* [Companion Notes](https://github.com/DataTalksClub/data-engineering-zoomcamp/tree/main/week_1_basics_n_setup/1_terraform_gcp/terraform)
...
st.markdown("### 🎥 GitHub Codespaces")

st.video("https://www.youtube.com/watch?v=XOSUt8Ih3zA&list=PL3MmuxUbc_hJed7dXYoJw8DoCuVHhGEQb")
...
st.info("""
* [Module 1 Homework](https://github.com/DataTalksClub/data-engineering-zoomcamp/blob/main/cohorts/2024/01-docker-terraform/homework.md)
""")
