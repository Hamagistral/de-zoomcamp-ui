...
or you fail your first attempt,  then you will have a second chance to submit your project as attempt #2. """)

st.error("There are only two attempts !")

st.info("""Remember that to pass the project, you must evaluate 3 peers. If you don't do that,
...
* Selecting a dataset of interest (see <a href="Datasets" target='_self'>Datasets</a>)
...
st.info("""- It's highly recommended to create a new repository for your project (not inside an existing repo) with a meaningful title, such as
- "Quake Analytics Dashboard" or "Bike Data Insights" and include as many details as possible in the README file. ChatGPT can assist you with this. Doing so will not only make it easier to showcase your project for potential job opportunities but also have it featured on the [Projects Gallery App](https://datatalksclub-projects.streamlit.app/).
- If you leave the README file empty or with minimal details, there may be point deductions as per the **Evaluation Criteria**.""")

st.markdown("### 🚀 Going the extra mile (Optional)")

st.info("- The following things are not covered in the course, are entirely optional and they will not be graded.")
...
Refer to the provided <a href="Datasets" target='_self'>datasets</a> for possible selection.
...
- **DE Zoomcamp 2023**: [2023 Projects](https://github.com/DataTalksClub/data-engineering-zoomcamp/blob/main/cohorts/2023/project.md)

- **DE Zoomcamp 2022**: [2022 Projects](https://github.com/DataTalksClub/data-engineering-zoomcamp/blob/main/cohorts/2022/project.md)
""", unsafe_allow_html=True)

st.markdown("---")
              
st.success("### 🛎️ Submitting")

st.markdown("""### Project Attempt #1
